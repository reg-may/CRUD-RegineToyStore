...
<logic:notEmpty name="users" >
      <table width="21%">
        ...
        <logic:iterate name="users" id="user"  indexId="userindex" type="com.regine.persistence.User">
          ...
          <bean:write name="userindex" />
            <tr> 
                ...
                <td bgcolor="#DBEAF9"><html:text  name="user" property="name" /></td>
                <td bgcolor="#DBEAF9"><html:text  name="user" property="age" /></td>
                <td><html:button value="Update" property="id" indexed="true" styleId="updateid" onclick="postForm('updateUser')" /></td>
            </tr>
           </html:form>
        </logic:iterate>
    </table>
